...
public class TesteMercado
{
    ...
    public RedeMercados montarTudo()
    {
        RedeMercados r = criarRede();
        r.setMercados(criarMercados(4));
        return r;
    }
    ...
    public RedeMercados criarRede()
    {
        RedeMercados r = new RedeMercados();
        r.setNome("Rede de Mercados");
        return r;
    }
}
